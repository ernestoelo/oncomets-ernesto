...
> Las siete láminas en un solo archivo, que es el método de `@humanizer-es`: se escribe entero,
...
## [s03a] El tamaño solo reencuentra el alto grado

Empiezo por el grado. La pregunta era si el detector, sin que nadie le diga dónde están las
marcas, llega a los mismos núcleos que marcó el patólogo.
...
entre los más grandes de su lámina, y una lista de los más grandes lo deja afuera. Para moderado
y bajo hace falta medir otra cosa que el tamaño, y la lámina siguiente dice cuál.

## [s03b] El CAP no cuenta núcleos
...
## [s03c] La atención cae sobre el CDIS ya visto
