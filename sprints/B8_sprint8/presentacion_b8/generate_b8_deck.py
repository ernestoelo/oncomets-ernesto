...
def build():
    ...
    notes(s, "La tabla compara el método sobre distintos modelos de base, y uno de ellos es "
             ...
             "nuestro, que es la fila destacada, bajan las dos: la exactitud algo más de un "
             "punto y el área bajo la curva un punto y medio, y los valores exactos están en "
             "la fila. Lo digo sin ánimo de desacreditar "
             "el trabajo, que me "
